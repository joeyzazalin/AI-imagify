   ...
   transition={{duration:0.2, delay:0.8}}
    >
      ...
      <img src={assets.star_icon} alt="" />
        ...
        <motion.p className='text-center max-w-wl mx-auto mt-5'
        initial={{opacity:0, y:20}}
        animate={{opacity:1, y:0}}
        transition={{duration:0.8, delay:0.6}}
        
        >Unleash your creativity with AI. Turn your imagination into visual art in seconds - prompt, and watch the magic happen.</motion.p>
